...
// Platform:    HP Spectre, Windows 10		                       //
...
* Public Interface:
*-------------------
* void InitialAnalysis(int argc, char* argv[], CodeAnalysisExecutive& exec)
*	-Initial Analysis that constructs AST and metrics for set of files. 
...
*	-Demos req number 3. 
*
* void DemoReq4(TypeTable& tt,ScopeStack<ElementType>& s,Display& display)
*	- Demos Req number 4.
*
* void DemoReq5(DepAnal& da, Display& display,std::string cmdArgm)
*	- Demos Req number 5
*
* void DemoReq6(Display& display, DepAnal& da, StrongComponents<std::string, std::string>& sc)
*	- Demos Req Number 6
*
* void DemoReq7(int argc, char* argv[], StrongComponents<std::string, std::string>& sc)
*	- Demos Req Number 7
*
* void DemoReq8(int argc, char* argv[])
*	-Demos Req Number 8
*
* void DemoReq3()
*	-Demos req number 3. 
*
* void getFilesAndAnalyse(DepAnal& d)
*	-Retrieves files and performs DepAnalysis by calling DepAnal
*
*
*  Required Files:
*  ---------------
...
namespace CodeAnalysis
{
  ...
  private:
	std::string xmlDepDefaultFilePath;
	std::string xmlScDefaultPath;
